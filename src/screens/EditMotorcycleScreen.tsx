...
export const EditMotorcycleScreen: React.FC<EditMotorcycleScreenProps> = ({ navigation, route }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    fabricante: motorcycle.fabricante,
  })
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true)
    try {
      await motorcycleService.update(motorcycle.id, {
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.iconContainer}>
            <View style={[styles.iconCircle, { backgroundColor: `${theme.primary}20` }]}>
              <Ionicons name="pencil" size={48} color={theme.primary} />
            </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.buttonContainer}>
              <CustomButton title="Salvar Alterações" onPress={handleSubmit} loading={loading} />
